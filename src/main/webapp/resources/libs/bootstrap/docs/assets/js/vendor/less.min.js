...
!function (a, b) {
    ...
    v === b && (v = exports, w = c("./tree"), v.mode = "node"), v.Parser = function (a) {
        ...
        return t.prototype = new Error, t.prototype.constructor = t, this.env = a = a || {}, this.optimization = "optimization"in this.env ? this.env.optimization : 1, F = {imports: I, parse: function (d, e, f) {
            ...
            if ("." === l || "#" === l) {
                for (d(); ;) {
                    if (b = x, g = i(/^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/), !g)break;
                    f = new w.Element(h, g, b, a.currentFileInfo), c ? c.push(f) : c = [f], h = j(">")
                }
                return c && (j("(") && (k = this.args(!0).args, m(")")), G.important() && (n = !0), G.end()) ? new w.mixin.Call(c, k, o, a.currentFileInfo, n) : (e(), void 0)
            }
        }, args: function (a) {
            ...
            return c ? new w.Selector(c, d, i, j, a.currentFileInfo) : (d && n("Extend must be used to extend a selector, it cannot be used on its own"), void 0)
        }, attribute: function () {
            if (j("[")) {
            ...
            for (d(), a.dumpLineNumbers && (g = s(x, u, a)); ;) {
                ...
                if (b ? b.push(c) : b = [c], this.comments(), c.condition && b.length > 1 && n("Guards are only currently allowed on a single selector."), !j(","))break;
        ...
        a.Dimension = function (c, d) {
            ...
            if (0 !== d && 1e-6 > d && d > -1e-6 && (e = d.toFixed(20).replace(/0+$/, "")), b && b.compress) {
                if (0 === d && this.unit.isLength())return c.add(e), void 0;
